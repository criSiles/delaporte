<template>
  <body>
    <nav class="navbar" @mouseover="isHovering = true" @mouseleave="isHovering = false">
      <ul class="navbar-nav">
        <li class="logo">
          <a href="#" class="nav-link">
            <img class="link-text logo-text" src="/src/assets/delaporte_logo.png" alt="Delaporte" />
            <svg
              v-show="!isHovering"
              aria-hidden="true"
              focusable="false"
        ...
        <li class="nav-item">
          <router-link class="nav-link" to="/delaporte/música">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
        ...
        <li class="nav-item">
          <router-link class="nav-link" to="/delaporte/tour">
            <svg
            ...
            <span class="link-text">Tour</span>
          </router-link>
        </li>

        <li class="nav-item">
          <router-link class="nav-link" to="/delaporte/tienda">
            <svg
        ...
        <li class="nav-item">
          <router-link class="nav-link" to="/delaporte/contacto">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
...
.nav-link {
  display: flex;
  align-items: center;
  /* Matches the width, our links will be a square */
  height: 5rem;
  color: var(--text-primary);
  text-decoration: none;
  /* This make that the color pink in the fa-primary and fa-secondary are not the default and pass it into a gray scale */
...
/* When the navbar is hovered, it update the link-text to display block and actually show */
